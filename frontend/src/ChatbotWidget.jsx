  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 font-sans chatbot-widget">
      ...
      {!open && (
        <button
          onClick={toggleOpen}
          className="group relative chatbot-trigger-button"
        >
          <svg 
          ...
          <div className="p-4 border-t-2 border-gray-100 bg-white">
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-3.5 rounded-2xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl disabled:hover:shadow-lg flex items-center justify-center min-w-[52px] send-button"
              >
                {loading ? (
